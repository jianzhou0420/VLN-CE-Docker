...
show_help() {
    ...
    echo "                    ARGS are passed to docker/vlnce/scripts/setup_data.sh"
    echo "                    Available: --mp3d, --rxr, --rxr-bert, --ddppo, --checkpoints, --all"
    echo ""
    ...
    echo "  $0 --vlnce --mp3d           # Download MP3D scenes only"
...
interactive_menu() {
    ...
    echo "     - Matterport3D scenes, RxR dataset, DDPPO models"
    echo ""
